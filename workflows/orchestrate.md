...
Agents must not edit the same files concurrently without an explicit ownership split. The orchestrator resolves conflicts, verifies the final tree after parallel work, and records skipped agents/checks as risks rather than silently treating them as passed.
